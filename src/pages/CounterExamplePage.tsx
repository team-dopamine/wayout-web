...
export default function CounterExamplePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-700 transition-colors duration-300 dark:bg-slate-900 dark:text-slate-200">
      ...
      <main className="relative flex flex-col items-center px-4 py-8 sm:px-6 lg:px-8">
